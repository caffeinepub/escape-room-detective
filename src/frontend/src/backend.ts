...
export class Backend implements backendInterface {
    ...
    async checkUnlockCode(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkUnlockCode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAttempts(): Promise<Array<AttemptRecord>> {
        if (this.processError) {
            try {
    ...
    async storePhoto(arg0: string, arg1: string, arg2: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storePhoto(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
