...
export default function LockScreenModal({ onUnlock, showBootAnimation }: LockScreenModalProps) {
  ...
  if (showBootAnimation) {
    return (
      <div className="py-12 flex items-center justify-center">
        <div className="animate-boot text-success font-mono text-lg space-y-2 text-center">
  ...
  return (
    <div className="space-y-6 py-4">
        ...
        <div className="flex justify-center mb-4">
          <div className="relative">
            <div className="w-20 h-20 relative flex items-center justify-center">
              <Lock className="w-12 h-12 text-primary animate-glow" />
            </div>
        ...
        <div className="flex justify-center gap-2">
          {Array.from({ length: CODE_LENGTH }).map((_, index) => (
            <input
              ...
              className={`
                w-10 h-14 text-center text-xl font-mono font-bold
        ...
        <div className="grid grid-cols-3 gap-2 max-w-xs mx-auto">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((digit) => (
            <Button
              ...
              className="h-12 text-lg font-mono font-bold hover:bg-primary/20 hover:text-primary hover:border-primary transition-all"
          ...
          <Button
            ...
            size="sm"
            onClick={handleClear}
            className="h-12 hover:bg-destructive/20 hover:text-destructive hover:border-destructive transition-all"
            disabled={checkCodeMutation.isPending}
          >
          ...
          <Button
            ...
            className="h-12 bg-primary text-primary-foreground hover:bg-primary/90 font-display text-base tracking-wider"
            disabled={checkCodeMutation.isPending}
          >
      ...
      {/* Footer */}
      <footer className="text-center text-xs font-mono text-muted-foreground pt-4">
