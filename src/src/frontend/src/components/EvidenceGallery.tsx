  ...
  return (
    <>
              ...
              <div className="flex items-center justify-center min-h-[400px]">
                <Card className="max-w-md border-accent/50 bg-accent/5">
                  <CardContent className="py-12 text-center">
                    ...
                    <h3 className="font-display text-lg mb-2">No Evidence Captured Yet</h3>
                    <p className="font-mono text-sm text-muted-foreground">
      ...
      <Dialog open={!!selectedPhoto} onOpenChange={(open) => !open && setSelectedPhoto(null)}>
        <DialogContent className="max-w-5xl w-full p-0">
          <DialogHeader className="p-6 pb-0">
            <DialogTitle className="font-display text-xl">Evidence Details</DialogTitle>
      ...
      <AlertDialog open={!!photoToDelete} onOpenChange={(open) => !open && setPhotoToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="font-display">Delete Evidence?</AlertDialogTitle>
            <AlertDialogDescription className="font-mono text-sm">
              This action cannot be undone. The photo will be permanently removed from the evidence archive.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
